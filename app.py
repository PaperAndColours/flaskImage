...
class PageTemplate(db.Model):
	...
	page_width = db.Column(db.Integer)
	page_height = db.Column(db.Integer)
	name = db.Column(db.String(length_name), nullable=False)
	background_color = db.Column(db.String(length_text), nullable=False)
...
class ImageElement(db.Model):
	...
	page_template = db.relationship('PageTemplate', backref='image_elements')

class TextElement(db.Model):
	id = db.Column(db.Integer, primary_key=True)
	page_template_id = db.Column(db.Integer, db.ForeignKey('page_template.id'))
	page_template = db.relationship('PageTemplate', backref='text_elements')
	...
	font = db.Column(db.String(length_text), nullable=False)
	size = db.Column(db.Integer, nullable=False)
	color = db.Column(db.String(length_text), nullable=False)
	decoration = db.Column(db.String(length_text), nullable=False)
	text = db.Column(db.String(length_text), nullable=False)
